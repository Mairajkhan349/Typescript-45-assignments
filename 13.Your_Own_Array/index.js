...
let mode_Of_Transportation = ["moterbike", "car", "train", "cycle"];
for (let i = 0; i < mode_Of_Transportation.length; i++) {
    console.log("I would like to own a " + mode_Of_Transportation[i]);
}
